...
def train(args):
    ...
    scheduler = get_scheduler(
        "cosine_with_min_lr",
        optim,
        num_warmup_steps=math.ceil(max_steps * 0.1),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_ckpt_num", type=int, default=2)
    ...
    parser.add_argument("--fp32", action="store_true", default=False, help="Enable float32")
    ...
    parser.add_argument(
        "--sft_loss_coef", type=float, default=0, help="Regularization with NLL loss, see LLama 3.1 tech report."
    )
